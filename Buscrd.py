...
def image_to_text(given_img):

    input_img= Image.open(given_img)
...
st.title("EXTRACTING BUSINESS CARD DATA WITH 'OCR(Optical Character Recognition)'")
st.write("")
  ...
  if method == "Modify":
    ...
    if button3:
        ...
        for index, row in concat_df.iterrows():
            ...
            df_from_sqlite = pd.read_sql_query(query, cursor)
